                                    ...
                                    <div class="panel-container show">
                                        ...
                                        @forelse($competitions as $competition)
                                            ...
                                            <div class="card border m-auto m-lg-0" style="max-width: 18rem;">
                                                <img src="@if($competition->getEmblemURL() != null) {{url($competition->getEmblemURL())}} @else https://via.placeholder.com/150 @endif" class="card-img-top" alt="...">
                                                <div class="card-body">
                                                    <h5 class="card-title">{{$competition->getName()}} - {{$competition->getArea()}}</h5>
                                                </div>
                                                <div class="card-body">
                                                    <p class="card-text">Kolejka: {{$competition->getMatchday()}}</p>
                                                    <small class="text-muted">Data aktualizacji: {{ $competition->getLastUpdated() }}</small>
                                                </div>
                                                    <div class="card-body">
