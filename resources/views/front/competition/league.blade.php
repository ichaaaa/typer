                                ...
                                <div id="panel-1" class="panel">
                                    <div class="panel-hdr">
                                        ...
                                        <div class="panel-toolbar">
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example"><button type="button" id="scorers-modal-button" class="btn btn-primary" data-attr="{{ route('scorers_list', ['competition_id' => $competition->getId()]) }}" data-toggle="modal" data-target=".default-example-modal-right-lg" data-title="Klasyfikacja strzelców">Strzelcy</button><button type="button" id="standings-modal-button" class="btn btn-primary" data-attr="{{ route('competition_standings', ['competition_id' => $competition->getId()]) }}" data-toggle="modal" data-target=".default-example-modal-right-lg" data-title="Tabela">Tabela</button></div>
